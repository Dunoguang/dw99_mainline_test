...
static int jpg_probe(struct platform_device *pdev)
{
	...
	jpg_hw_dev.ahb_parent_clk = NULL;
	jpg_hw_dev.emc_parent_clk = NULL;
...
static void jpg_remove(struct platform_device *pdev)
{
	...
	if (jpg_hw_dev.clk_ahb_vsp)
		clk_put(jpg_hw_dev.clk_ahb_vsp);

	if (jpg_hw_dev.clk_emc_vsp)
		clk_put(jpg_hw_dev.clk_emc_vsp);
	...
	if (jpg_hw_dev.clk_aon_jpg_eb)
		clk_put(jpg_hw_dev.clk_aon_jpg_eb);

	if (jpg_hw_dev.clk_aon_jpg_emc_eb)
		clk_put(jpg_hw_dev.clk_aon_jpg_emc_eb);
