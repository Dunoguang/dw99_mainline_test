...
static DEVICE_ATTR(enable, S_IRWXU | S_IRWXG | S_IROTH,
...
*/
	...
	printk("sprd-gsensor: -- %s -- success !\n",__func__);
	{
		...
		zyt_info_s2("[GSensor] : ","LIS3DH_CDC");
	}	
	return 0;
...
static void lis3dh_acc_remove(struct i2c_client *client)
{
