...
static int sprd_clk_divider_determine_rate(struct clk_hw *hw,
					   struct clk_rate_request *req)
{
	req->rate = sprd_clk_divider_round_rate(hw, req->rate,
...
static struct clk_ops sprd_mux_ops = {
...
struct clk_ops sprd_divider_ops = {
	...
	.determine_rate = sprd_clk_divider_determine_rate,
