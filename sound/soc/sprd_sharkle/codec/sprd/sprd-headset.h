...
struct sprd_headset {
	...
	struct wakeup_source *micbias_wakelock;
};
...
void sprd_headset_set_global_variables(struct sprd_headset_global_vars *);
...
void sprd_headset_power_deinit(void);
	...
	defined(CONFIG_SND_SOC_SPRD_CODEC_SC2723_MODULE) || \
	defined(CONFIG_SND_SOC_SPRD_CODEC_SC2731) || \
	defined(CONFIG_SND_SOC_SPRD_CODEC_SC2731_MODULE) || \
	defined(CONFIG_SND_SOC_SPRD_CODEC_SC2721) || \
	defined(CONFIG_SND_SOC_SPRD_CODEC_SC2721_MODULE)
