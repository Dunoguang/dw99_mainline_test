...
void susfs_sus_kstat_spoof_show_map_vma(struct inode *inode, dev_t *out_dev, u64 *out_ino) {
	struct st_susfs_sus_kstat_hlist *entry = NULL;
	struct fuse_inode *fi = NULL;
...
int susfs_open_redirect_spoof_show_map_vma_srcu(struct inode *inode, u64 *out_ino, dev_t *out_dev, char **out_spoofed_name) {
	struct st_susfs_open_redirect_hlist *entry = NULL;
