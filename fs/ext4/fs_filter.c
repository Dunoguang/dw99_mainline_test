...
static int analyse_separate(char *str, char str_array[][MAX_SIZE], char *needle)
{
	int i = 0;
	char *buf = NULL;
...
static const struct proc_ops black_list_proc_fops = {
	.proc_open = black_list_proc_open,
	.proc_read = seq_read,
	.proc_write = black_list_proc_write,
...
static const struct proc_ops white_list_proc_fops = {
	.proc_open = white_list_proc_open,
	.proc_read = seq_read,
	.proc_write = white_list_proc_write,
	.proc_lseek = seq_lseek,
	.proc_release = single_release,
};
...
static const struct proc_ops black_list_comm_proc_fops = {
	.proc_open = black_list_comm_proc_open,
	.proc_read = seq_read,
	.proc_write = black_list_comm_proc_write,
	.proc_lseek = seq_lseek,
	.proc_release = single_release,
};
...
static const struct proc_ops white_list_comm_proc_fops = {
	.proc_open = white_list_comm_proc_open,
	.proc_read = seq_read,
	.proc_write = white_list_comm_proc_write,
	.proc_lseek = seq_lseek,
	.proc_release = single_release,
};
...
static const struct proc_ops app_guid_proc_fops = {
	.proc_open = app_guid_proc_open,
	.proc_read = seq_read,
	.proc_write = app_guid_proc_write,
	.proc_lseek = seq_lseek,
	.proc_release = single_release,
};
...
static bool is_in_black_list(uid_t euid, gid_t egid)
{
	bool ret = false;
	int i = 0, j = 0;
...
static int is_in_white_list(void)
{
	int i = 0;
	kgid_t cur_mgid;
	bool ret = false;
